...
export interface RoleState {
  roleList?: RoleInter[];
  openRoleFormModal: boolean;
}

const initialState: RoleState = {
  roleList: [],
  openRoleFormModal: false,
};
...
export const roleSlice = createSlice({
  ...
  reducers: {
    setOpenRoleFormModal: (state, action: PayloadAction<boolean>) => {
      state.openRoleFormModal = action.payload;
    },
  },
...
export const { setOpenRoleFormModal } = roleSlice.actions;
...
export const selectOpenModel = (state: RootState) =>
  state.roleReducer.openRoleFormModal;
